...
<div class="container">
    <div class="row justify-content-center">
        <div class="col-md-4">
            <div class="card">
                <form method="post" action="{{url("/formation/add")}}" enctype="multipart/form-data">
                    @csrf
                    <div class="card-header bg-light">
                        <h5 class="mb-0">New Formation</h5>
                    </div>
                    <div class="card-body">
                        <div class="mb-3">
                            <label class="form-label" for="exampleFormControlInput1">Title</label>
                            <input required class="form-control" name="name" placeholder="Laravel">
                        </div>
                        <div class="mb-3">
                            <label class="form-label" for="exampleFormControlInput1">Type</label>
                            <input required class="form-control" name="type" placeholder="Beginner">
                        </div>
                        <div class="mb-3">
                            <label class="form-label" for="exampleFormControlInput1">Description</label>
                            <input required class="form-control" name="description" placeholder="Amazing course">
                        </div>
                        <div class="mb-3">
                            <label class="form-label" for="exampleFormControlInput1">Image</label>
                            <input required class="form-control" type="file" name="picture" placeholder="Chapter image">
                        </div>
                        ...
                        <select class="form-select js-choice" id="organizerMultiple" multiple="multiple" size="1" name="categories[]" data-options='{"removeItemButton":true,"placeholder":true}'>
                            <option value="">Select category(ies)</option>
                        ...
                        <div class="mb-3">
                            ...
                            <input required class="form-control"  name="price" placeholder="50 €">
                        </div>
                        <div class="card-footer d-flex flex-between-center">
                            <div class="d-flex align-items-center">
                                <button class="btn btn-primary btn-sm px-5 me-2" type="submit">Create</button>
                                    ...
                                    <div class="overflow-hidden">
                                        <div class="position-relative rounded-top overflow-hidden">
                                            ...
                                            <a class="d-block" href="{{url("/formation/edit/$formation->id")}}">
                                                <img style="height: 200px;object-fit: cover" class="card-img-top " height="150" src="{{asset("assets/img/generic/$formation->picture")}}" alt="" />
                                            </a>
                                            ...
                                            <div class="p-4 pb-0">
                                                <form method="post" action="{{url("/home/edit/$formation->id")}}" enctype="multipart/form-data">
                                                    ...
                                                    <div class="mb-3">
                                                        ...
                                                        <input required class="form-control" name="price" value="{{$formation->price}}" id="message-text">
                                                    </div>
                                                ...
                                                <form id="delete-form{{$formation->id}}" action="{{ url("/home/delete/$formation->id") }}" method="POST" class="d-none">
                                                    @csrf
                                                    @method('delete')
                                                </form>
                                            </div>
